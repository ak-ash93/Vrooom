...
const Home = () => {
  return (
    <>
      <div className="bg-cover bg-[url(https://res.cloudinary.com/drk8qt8ak/image/upload/w_1000,ar_16:9,c_fill,g_auto,e_sharpen/v1748786293/taxi_image_swqmlt.jpg)] h-screen w-screen bg-red-400 pt-8  flex justify-between flex-col  ">
        <div>
